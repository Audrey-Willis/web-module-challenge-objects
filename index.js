...
console.log(createMenuItem("Milkshake", 3, "Drinks"));
/* Task 1b: use your function to create 3 more menu items. You may add any items to the menu that you'd like */
console.log(createMenuItem("Chicken Sandwhich", 5, "Lunch"));
console.log(createMenuItem("French Fries", 3, "Sides"));
console.log(createMenuItem("Banana Split", 5, "Desert"));
...
reviews.push({name: "Audrey", rating: 4.5, feedback: "loved the food"});
console.log(reviews);
